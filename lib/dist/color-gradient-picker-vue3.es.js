...
const _hoisted_2$4 = { class: "picker-area-overlay2 wh-full rounded-8px" };
...
const index_vue_vue_type_style_index_0_scoped_20f6e68e_lang = "";
...
const Picker = /* @__PURE__ */ _export_sfc(_sfc_main$f, [["__scopeId", "data-v-20f6e68e"]]);
...
const index_vue_vue_type_style_index_0_scoped_61cbbc2c_lang = "";
const Hue = /* @__PURE__ */ _export_sfc(_sfc_main$d, [["__scopeId", "data-v-61cbbc2c"]]);
...
const index_vue_vue_type_style_index_0_scoped_355ba501_lang = "";
const Alpha = /* @__PURE__ */ _export_sfc(_sfc_main$c, [["__scopeId", "data-v-355ba501"]]);
...
const _hoisted_2$3 = { class: "flex pb-16px" };
...
const _hoisted_2$2 = ["maxlength", "type"];
...
const index_vue_vue_type_style_index_0_scoped_6124313e_lang = "";
const CInput = /* @__PURE__ */ _export_sfc(_sfc_main$8, [["__scopeId", "data-v-6124313e"]]);
...
const _hoisted_2$1 = { class: "w-full flex justify-between" };
...
const _withScopeId = (n) => (pushScopeId("data-v-14668158"), n = n(), popScopeId(), n);
...
const index_vue_vue_type_style_index_0_scoped_14668158_lang = "";
const GradientControls = /* @__PURE__ */ _export_sfc(_sfc_main$2, [["__scopeId", "data-v-14668158"]]);
...
const _hoisted_1 = { class: "picker-color-ui border-box w-280px m-8px bg-[#fff] flex flex-col slelect-none" };
...
const _sfc_main = /* @__PURE__ */ defineComponent(__spreadProps(__spreadValues({}, __default__), {
  ...
  setup(__props, { emit: emits }) {
    ...
    const color = ref(
      props.color ? Object.assign(cloneDeep(defaultColor), props.color) : cloneDeep(defaultColor)
    );
    const gradient = ref(
      props.gradient ? Object.assign(cloneDeep(defaultGradient), props.gradient) : cloneDeep(defaultGradient)
    );
    const colorPickerState = reactive({
      isGradient: props.isGradient,
      // 是否是渐变
      red: props.isGradient ? (_a = gradient.value) == null ? void 0 : _a.points[1].red : (_b = color.value) == null ? void 0 : _b.red,
      green: props.isGradient ? (_c = gradient.value) == null ? void 0 : _c.points[1].green : (_d = color.value) == null ? void 0 : _d.green,
      blue: props.isGradient ? (_e = gradient.value) == null ? void 0 : _e.points[1].blue : (_f = color.value) == null ? void 0 : _f.blue,
      alpha: props.isGradient ? (_g = gradient.value) == null ? void 0 : _g.points[0].alpha : (_h = color.value) == null ? void 0 : _h.alpha,
      hue: 0,
      saturation: 100,
      value: 100,
      style: "",
    ...
    function updateGradient(color2, key) {
      const {
        red = 0,
        green = 0,
        blue = 0,
      ...
      if (key) {
        colorPickerState[key] = color2[key];
      } else {
    ...
    function updateSolid(color2, key) {
      const { red = 0, green = 0, blue = 0, alpha, hue, saturation, value } = color2;
      if (key) {
        colorPickerState[key] = color2[key];
      } else {
        colorPickerState.red = red;
