import { defineComponent as f, ref as X, reactive as G, computed as y, onMounted as E, openBlock as b, createElementBlock as C, normalizeStyle as S, unref as w, createElementVNode as v, normalizeClass as F, withModifiers as te, Fragment as T, renderList as ne, createBlock as I, createVNode as P, createCommentVNode as j, withDirectives as oe, isRef as ae, vModelText as re, toDisplayString as W, watch as M, getCurrentInstance as le, onBeforeUnmount as ie } from "vue";
function R({
  red: n,
  green: t,
  blue: e,
...
function ce(n) {
  if (ue.test(n)) {
    if (n[0] === "#" && (n = n.slice(1, n.length)), n.length < 6)
      return;
    const e = parseInt(n.substring(0, 2), 16) || 0, o = parseInt(n.substring(2, 4), 16) || 0, l = parseInt(n.substring(4, 6), 16) || 0, s = parseInt(n.substring(6, 10), 16) / 255 || 0, a = N(e, o, l, s), r = a && R({ ...a });
    return {
      ...a,
      ...r
    };
  ...
  setup(n) {
    ...
    return E(() => {
      ...
      v("div", {
        ...
        (b(!0), C(T, null, ne(t.points, (g, d) => (b(), I(ke, {
          key: d,
...
}), Be = { class: "input-container" }, Fe = { class: "label" }, Re = f({
  name: "Input"
}), Ie = /* @__PURE__ */ f({
  ...Re,
  props: {
    ...
    type: { default: "text" },
    classes: { default: "" },
    onFocus: { type: Function, default: () => !1 },
    onBlur: { type: Function, default: () => !1 }
  },
...
const Ve = (n, t) => {
  ...
  for (const [o, l] of t)
    e[o] = l;
  return e;
}, Q = /* @__PURE__ */ Ve(Ie, [["__scopeId", "data-v-3d2a573b"]]), Ae = f({
  name: "Preview"
}), De = /* @__PURE__ */ f({
  ...Ae,
  props: {
  ...
  setup(n) {
    ...
    }), o = y(() => t.hue === void 0 || t.saturation === void 0 || t.value === void 0 ? R({
      red: t.red,
      green: t.green,
      blue: t.blue
    }) : {
    ...
    return E(() => {
      const { hue: a, saturation: r, value: g } = R({
        red: e.colorRed,
        green: e.colorGreen,
        blue: e.colorBlue
      });
  ...
  setup(n) {
    const t = n, e = G({
      ...
      const { hue: m, saturation: x, value: k } = R({ red: c, green: i, blue: p });
    ...
    return E(() => {
      const { hue: u, saturation: c, value: i } = R({
        red: e.colorRed,
        green: e.colorGreen,
        blue: e.colorBlue
      });
  ...
  setup(n) {
    ...
    return (e, o) => (b(), C("div", ot, [
      ...
      }, null, 8, ["points", "type", "degree", "on-change", "on-start-change", "on-end-change"])) : (b(), I(je, {
        key: 1,
        red: t.color.red,
        green: t.color.green,
        blue: t.color.blue,
