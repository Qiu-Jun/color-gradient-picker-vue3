...
function useColor() {
  ...
  const deletePoint = (index) => {
    ...
    if (colors && (colors == null ? void 0 : colors.length) > 2) {
      const pointToDelete = index != null ? index : colorState.gradientColorsIdx;
...
const _sfc_main$g = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    const handleSetIsGradient = debounce(function(mode) {
      if (colorState2.mode === mode) return;
      setMode(mode);
...
const _sfc_main$f = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    const handleChangeType = debounce(function(type) {
      if (type === unref(gradientType2)) return;
...
const _hoisted_1$5 = { class: "cpg-inputs-wrap" };
...
const _hoisted_1$4 = { class: "cpg-gradientBar-warp" };
...
const _hoisted_1$1 = { class: "cpg-advance-item" };
...
const _hoisted_1 = { class: "cpg-advance-wrap" };
