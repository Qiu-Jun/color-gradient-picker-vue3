...
const _sfc_main = /* @__PURE__ */ defineComponent(__spreadProps(__spreadValues({}, __default__), {
  ...
  setup(__props, { expose, emit: emits }) {
    ...
    const colorPickerState = reactive({
      ...
      green: props.isGradient ? props.color.points[lastPoint].green : props.color.green,
      blue: props.isGradient ? props.color.points[lastPoint].blue : props.color.blue,
      alpha: props.isGradient ? props.color.points[lastPoint].alpha : props.color.alpha,
      hue: 0,
      saturation: 100,
      // 饱和
      value: 100,
