...
import 'file:///Users/june/Desktop/color-gradient-picker-vue3/node_modules/.pnpm/registry.npmmirror.com+node-fetch-native@1.1.0/node_modules/node-fetch-native/dist/polyfill.mjs';
...
import {
    provider,
    isWindows,
} from 'file:///Users/june/Desktop/color-gradient-picker-vue3/node_modules/.pnpm/registry.npmmirror.com+std-env@3.3.2/node_modules/std-env/dist/index.mjs';
import {
    defineEventHandler,
    handleCacheHeaders,
    createEvent,
    ...
    getQuery,
    createError,
} from 'file:///Users/june/Desktop/color-gradient-picker-vue3/node_modules/.pnpm/registry.npmmirror.com+h3@1.6.4/node_modules/h3/dist/index.mjs';
...
import {
    ...
    Headers,
} from 'file:///Users/june/Desktop/color-gradient-picker-vue3/node_modules/.pnpm/registry.npmmirror.com+ofetch@1.0.1/node_modules/ofetch/dist/node.mjs';
...
import {
    createCall,
    createFetch,
} from 'file:///Users/june/Desktop/color-gradient-picker-vue3/node_modules/.pnpm/registry.npmmirror.com+unenv@1.3.1/node_modules/unenv/runtime/fetch/index.mjs';
...
import defu, {
    defuFn,
} from 'file:///Users/june/Desktop/color-gradient-picker-vue3/node_modules/.pnpm/registry.npmmirror.com+defu@6.1.2/node_modules/defu/dist/defu.mjs';
...
import {
    ...
    joinURL,
    withQuery,
} from 'file:///Users/june/Desktop/color-gradient-picker-vue3/node_modules/.pnpm/registry.npmmirror.com+ufo@1.1.1/node_modules/ufo/dist/index.mjs';
import {
    createStorage,
    prefixStorage,
} from 'file:///Users/june/Desktop/color-gradient-picker-vue3/node_modules/.pnpm/registry.npmmirror.com+unstorage@1.4.1/node_modules/unstorage/dist/index.mjs';
...
import {
    toRouteMatcher,
    createRouter,
} from 'file:///Users/june/Desktop/color-gradient-picker-vue3/node_modules/.pnpm/registry.npmmirror.com+radix3@1.0.1/node_modules/radix3/dist/index.mjs';
...
const serverAssets = [
    {
        baseName: 'server',
        dir: '/Users/june/Desktop/color-gradient-picker-vue3/packages/nuxi/server/assets',
    },
];
...
storage.mount(
    ...
    unstorage_47drivers_47fs({
        driver: 'fs',
        readOnly: true,
        base: '/Users/june/Desktop/color-gradient-picker-vue3/packages/nuxi',
...
storage.mount(
    ...
    unstorage_47drivers_47fs({
        driver: 'fs',
        readOnly: true,
        base: '/Users/june/Desktop/color-gradient-picker-vue3/packages/nuxi/server',
        ignore: ['**/node_modules/**', '**/.git/**'],
    }),
);
storage.mount(
    ...
    unstorage_47drivers_47fs({
        driver: 'fs',
        readOnly: false,
        base: '/Users/june/Desktop/color-gradient-picker-vue3/packages/nuxi/.nuxt',
        ignore: ['**/node_modules/**', '**/.git/**'],
    }),
);
storage.mount(
    ...
    unstorage_47drivers_47fs({
        driver: 'fs',
        readOnly: false,
        base: '/Users/june/Desktop/color-gradient-picker-vue3/packages/nuxi/.nuxt/cache',
        ignore: ['**/node_modules/**', '**/.git/**'],
    }),
);
...
function defineCachedEventHandler(handler, opts = defaultCacheOptions) {
    const _opts = {
        ...
        getKey: async (event) => {
            ...
            const friendlyName = escapeKey(
                decodeURI(parseURL(url).pathname),
            ).slice(0, 16);
...
const getClientManifest = () =>
    import(
        '/Users/june/Desktop/color-gradient-picker-vue3/packages/nuxi/.nuxt/dist/server/client.manifest.mjs'
    )
        .then((r) => r.default || r)
...
const getServerEntry = () =>
    import(
        '/Users/june/Desktop/color-gradient-picker-vue3/packages/nuxi/.nuxt/dist/server/server.mjs'
    ).then((r) => r.default || r);
