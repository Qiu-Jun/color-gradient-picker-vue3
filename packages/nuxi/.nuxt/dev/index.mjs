globalThis._importMeta_={url:import.meta.url,env:process.env};import 'file:///Users/june/Desktop/color-gradient-picker-vue3/node_modules/.pnpm/registry.npmmirror.com+node-fetch-native@1.1.0/node_modules/node-fetch-native/dist/polyfill.mjs';
import { Server } from 'node:http';
import { tmpdir } from 'node:os';
import { join } from 'node:path';
import { mkdirSync } from 'node:fs';
import { parentPort, threadId } from 'node:worker_threads';
import { provider, isWindows } from 'file:///Users/june/Desktop/color-gradient-picker-vue3/node_modules/.pnpm/registry.npmmirror.com+std-env@3.3.2/node_modules/std-env/dist/index.mjs';
import { defineEventHandler, handleCacheHeaders, createEvent, eventHandler, setHeaders, sendRedirect, proxyRequest, setResponseStatus, getRequestHeader, setResponseHeader, getRequestHeaders, createApp, createRouter as createRouter$1, toNodeListener, fetchWithEvent, lazyEventHandler, getQuery, createError } from 'file:///Users/june/Desktop/color-gradient-picker-vue3/node_modules/.pnpm/registry.npmmirror.com+h3@1.6.4/node_modules/h3/dist/index.mjs';
import { createRenderer } from 'file:///Users/june/Desktop/color-gradient-picker-vue3/node_modules/.pnpm/registry.npmmirror.com+vue-bundle-renderer@1.0.3/node_modules/vue-bundle-renderer/dist/runtime.mjs';
import devalue from 'file:///Users/june/Desktop/color-gradient-picker-vue3/node_modules/.pnpm/registry.npmmirror.com+@nuxt+devalue@2.0.0/node_modules/@nuxt/devalue/dist/devalue.mjs';
...
import { hash } from 'file:///Users/june/Desktop/color-gradient-picker-vue3/node_modules/.pnpm/registry.npmmirror.com+ohash@1.0.0/node_modules/ohash/dist/index.mjs';
import { parseURL, withoutBase, joinURL, withQuery } from 'file:///Users/june/Desktop/color-gradient-picker-vue3/node_modules/.pnpm/registry.npmmirror.com+ufo@1.1.1/node_modules/ufo/dist/index.mjs';
import { createStorage, prefixStorage } from 'file:///Users/june/Desktop/color-gradient-picker-vue3/node_modules/.pnpm/registry.npmmirror.com+unstorage@1.4.1/node_modules/unstorage/dist/index.mjs';
import unstorage_47drivers_47fs from 'file:///Users/june/Desktop/color-gradient-picker-vue3/node_modules/.pnpm/registry.npmmirror.com+unstorage@1.4.1/node_modules/unstorage/drivers/fs.mjs';
import { toRouteMatcher, createRouter } from 'file:///Users/june/Desktop/color-gradient-picker-vue3/node_modules/.pnpm/registry.npmmirror.com+radix3@1.0.1/node_modules/radix3/dist/index.mjs';
...
const serverAssets = [{"baseName":"server","dir":"/Users/june/Desktop/color-gradient-picker-vue3/packages/nuxi/server/assets"}];
...
storage.mount('root', unstorage_47drivers_47fs({"driver":"fs","readOnly":true,"base":"/Users/june/Desktop/color-gradient-picker-vue3/packages/nuxi","ignore":["**/node_modules/**","**/.git/**"]}));
storage.mount('src', unstorage_47drivers_47fs({"driver":"fs","readOnly":true,"base":"/Users/june/Desktop/color-gradient-picker-vue3/packages/nuxi/server","ignore":["**/node_modules/**","**/.git/**"]}));
storage.mount('build', unstorage_47drivers_47fs({"driver":"fs","readOnly":false,"base":"/Users/june/Desktop/color-gradient-picker-vue3/packages/nuxi/.nuxt","ignore":["**/node_modules/**","**/.git/**"]}));
storage.mount('cache', unstorage_47drivers_47fs({"driver":"fs","readOnly":false,"base":"/Users/june/Desktop/color-gradient-picker-vue3/packages/nuxi/.nuxt/cache","ignore":["**/node_modules/**","**/.git/**"]}));
...
const _lazy_O5Swx7 = () => Promise.resolve().then(function () { return renderer$1; });

const handlers = [
  { route: '/__nuxt_error', handler: _lazy_O5Swx7, lazy: true, middleware: false, method: undefined },
  { route: '/**', handler: _lazy_O5Swx7, lazy: true, middleware: false, method: undefined }
];
...
const getClientManifest = () => import('/Users/june/Desktop/color-gradient-picker-vue3/packages/nuxi/.nuxt/dist/server/client.manifest.mjs').then((r) => r.default || r).then((r) => typeof r === "function" ? r() : r);
const getStaticRenderedHead = () => Promise.resolve().then(function () { return _virtual__headStatic$1; }).then((r) => r.default || r);
const getServerEntry = () => import('/Users/june/Desktop/color-gradient-picker-vue3/packages/nuxi/.nuxt/dist/server/server.mjs').then((r) => r.default || r);
